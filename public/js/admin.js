...
function showUsersTab(deleteErrorMessage) {
    ...
    $autocompleteDropDown = $('<section>', {
        id: 'autocomplete-drop-down'
    });

    $searchBox = $('<input/>', {
        type: 'text',
        placeholder: 'Search by user name    (e.g. type "Jeff")'
    });
    ...
    $searchBox.autocomplete({
        ...
        params: {
            type: 'users',
            limit: 8
        }, // TODO: Should it by username or users name ?
